...
public class veterok_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("ÍÀ ÑÊËÀÄÅ")>=0){
			...
			try{
				...
				String priceElementText=priceElement.getTextContent().trim().toUpperCase().replaceAll("[À-ßA-Z $,]", "");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://veterok.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://veterok.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr[4]/td[2]/table/tbody/tr[2]/td[2]/span/center/p[2]/table/tbody";
	}
