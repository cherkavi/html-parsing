...
public class mobil_house_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.mobil-house.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.mobil-house.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table/tbody/tr/td/div[4]/table/tbody/tr/td[2]/table[3]/tbody/tr/td/table/tbody";
	}
