...
public class mvideo_kiev_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.mvideo.kiev.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.mvideo.kiev.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table/tbody/tr[3]/td/table/tbody/tr/th[2]/table/tbody/tr[2]/td/center/p[2]/table/tbody";
	}
