...
public class maf_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.maf.com.ua/conditioner/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.maf.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr[2]/td/table/tbody/tr/td[2]/table/tbody/tr/td/center/table/tbody";
	}
