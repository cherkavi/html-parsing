...
public class ciframir_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.ciframir.com.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.ciframir.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr[2]/td/table/tbody/tr/td[2]/table[3]/tbody/tr/td/table/tbody";
	}
