...
public class starstore_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://starstore.com.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://starstore.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[5]/tbody/tr/td[2]/table/tbody/tr[2]/td/table/tbody";
	}
