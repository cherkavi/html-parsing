...
public class bigmag_biz_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://bigmag.biz.ua/pricelist/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://bigmag.biz.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div[2]/table/tbody/tr[2]/td[2]/div/div[2]/center/p[2]/table/tbody";
	}
