...
public class tel_in_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://tel.in.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://tel.in.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[2]/td/center/p[2]/table/tbody";
	}
