...
public class taxfree_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		if(((Element)this.parser.getNodeFromNode(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				Element priceElement=(Element)this.parser.getNodeFromNode(node, "/td[3]/nobr");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://taxfree.com.ua/pricelist.htm";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://taxfree.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[2]/td[2]/table/tbody/tr[5]/td/table/tbody";
	}
