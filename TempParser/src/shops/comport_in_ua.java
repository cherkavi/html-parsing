...
public class comport_in_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://comport.in.ua/index.php?ukey=pricelist";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://comport.in.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table[2]/tbody/tr/td[2]/div/div/center/div[2]/p[2]/table/tbody";
	}
