...
public class bosch_kiev_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://bosch-kiev.com.ua/index.php?ukey=pricelist";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://bosch-kiev.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/HTML/BODY/TABLE/TBODY/TR[2]/TD[@id=\"container_main_content\"]/DIV[@class=\"round-container\"]/DIV[@class=\"cpt_maincontent cptovst_vg6a7y\"]/CENTER/P[2]/TABLE/TBODY";
	}
