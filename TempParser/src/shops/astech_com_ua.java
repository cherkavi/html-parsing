...
public class astech_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.astech.com.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.astech.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[2]/tbody/tr/td/table/tbody/tr/td[2]/div[2]/div/div/div/div/div/div/div/table[3]/tbody/tr/td/table/tbody";
	}
