...
public class plasma_lcd_com_ua extends AnalisatorRecordListBaseMultiPage {
	@Override
	public String getShopUrlStartPage() {
		return "http://www.plasma-lcd.com.ua/";
	}
	...
	protected String[] getThreePageForAnalisator() {
		return new String[] {
				"http://www.plasma-lcd.com.ua/category.php?intCategoryID=7",
				"http://www.plasma-lcd.com.ua/category.php?intCategoryID=7&page=2",
				"http://www.plasma-lcd.com.ua/category.php?intCategoryID=7&page=3", };
	}
