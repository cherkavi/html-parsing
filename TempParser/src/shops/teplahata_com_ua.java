...
public class teplahata_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				url=this.removeAfterSymbolIncludeIt(removeStartPage(nodeName.getAttribute("href")),'&');
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.teplahata.com.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.teplahata.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[3]/tbody/tr/td[2]/table/tbody/tr[2]/td/table/tbody";
	}
