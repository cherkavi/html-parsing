...
public class pilesos_kiev_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://pilesos.kiev.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://pilesos.kiev.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div[2]/div/div[10]/div[3]/div[2]/span/center/table[2]/tbody";
	}
