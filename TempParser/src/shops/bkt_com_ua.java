...
public class bkt_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				url=this.removeAfterSymbolIncludeIt(this.removeStartPage(nodeName.getAttribute("href")),'&');
				...
				price=this.getFloatFromString(priceElementText);
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.bkt.com.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.bkt.com.ua";
	}
	...
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr/td[2]/div/table/tbody/tr[2]/td/table/tbody";
	}
