...
public class battup_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				int apersant=url.indexOf('&');
				if(apersant>0){
					url=url.substring(0,apersant);
				}
	...
	protected String getFullHttpUrlToPrice() {
		return "http://battup.com.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://battup.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table/tbody/tr[3]/td/table/tbody/tr/td[2]/table/tbody";
	}
