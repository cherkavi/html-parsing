...
public class hacker_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://hacker.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://hacker.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr[4]/td[3]/table/tbody/tr/th/span/center/p[2]/table/tbody";
	}
