...
public class bmcable_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				Element nodeName=(Element)this.parser.getNodeFromNode(node, "/td[2]/a[2]");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://bmcable.com/shop_content.php?coID=112";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://bmcable.com";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr/td[2]/table/tbody/tr/td/table/tbody/tr/td/table/tbody";
	}
