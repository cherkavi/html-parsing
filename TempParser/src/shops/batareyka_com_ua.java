...
public class batareyka_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.batareyka.com.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.batareyka.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr[3]/td[2]/table[2]/tbody/tr/td/table/tbody/tr/td[2]/table[3]/tbody/tr/td/table/tbody";
	}
