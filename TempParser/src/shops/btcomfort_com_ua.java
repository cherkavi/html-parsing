...
public class btcomfort_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://btcomfort.com.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://btcomfort.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table/tbody/tr/td[2]/table[3]/tbody/tr/td/table/tbody";
	}
