...
public class medex_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://medex.com.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://medex.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/table[3]/tbody/tr/td[2]/div/div/div/div/div/div/div/div/table[4]/tbody/tr/td/table/tbody";
	}
