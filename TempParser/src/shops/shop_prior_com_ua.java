...
public class shop_prior_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://shop-prior.com.ua/price/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://shop-prior.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[2]/tbody/tr/td[4]/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody";
	}
