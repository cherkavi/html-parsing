...
public class ekoklimat_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://ekoklimat.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://ekoklimat.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/table[3]/tbody/tr/td[3]/table/tbody/tr/td/table/tbody/tr/td/center/p[2]/table/tbody";
	}
