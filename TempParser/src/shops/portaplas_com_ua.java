...
public class portaplas_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://portaplas.com.ua/shop/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://portaplas.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr[3]/td[2]/table/tbody/tr/td[2]/center/p[2]/table/tbody";
	}
