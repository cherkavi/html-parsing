...
public class domotech_kiev_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.domotech.kiev.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.domotech.kiev.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[4]/tbody/tr/td[2]/table/tbody/tr[2]/td/table[2]/tbody/tr/td[2]/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody";
	}
