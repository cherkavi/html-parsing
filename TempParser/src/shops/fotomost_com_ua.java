...
public class fotomost_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.fotomost.com.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.fotomost.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table/tbody/tr/td[3]/table/tbody/tr[3]/td/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody";
	}
