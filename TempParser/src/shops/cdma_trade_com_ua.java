...
public class cdma_trade_com_ua extends TableSinglePage{

	@Override
	protected Record getRecordFromRow(Node node) {
		if(((Element)this.parser.getNodeFromNode(node, "/td[3]")).getTextContent().indexOf("есть в наличии")>=0){
			...
			try{
				...
				Element nodeName=(Element)this.parser.getNodeFromNode(node, "/td[1]/a/b");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://cdma-trade.com.ua/phones.php?price=list";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://cdma-trade.com.ua";
	}
