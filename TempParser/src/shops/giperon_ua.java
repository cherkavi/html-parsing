...
public class giperon_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://giperon.ua/pricelist/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://giperon.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/div/table/tbody/tr[3]/td[2]/div/center/p[2]/table/tbody";
	}
