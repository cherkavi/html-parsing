...
public class hilink_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://hilink.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://hilink.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[5]/tbody/tr/td[2]/table[2]/tbody/tr/td[2]/table[3]/tbody/tr/td/table/tbody";
	}
