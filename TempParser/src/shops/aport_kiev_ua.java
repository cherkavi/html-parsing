...
public class aport_kiev_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.aport.kiev.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.aport.kiev.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/div[2]/table/tbody/tr/td[2]/table[2]/tbody/tr/td/table/tbody";
	}
