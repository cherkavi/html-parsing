...
public class i_mart_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://i-mart.com.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://i-mart.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[2]/tbody/tr/td[2]/center/p[2]/table/tbody";
	}
