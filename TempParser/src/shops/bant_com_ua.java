...
public class bant_com_ua extends TableSinglePage{
	...
	protected boolean isSection(Node node) {
		if(this.parser.getChildElementCount(node, "td")==1){
			try{
				Element element=(Element)this.parser.getNodeFromNode(node, "td");
				String attributeColor=element.getAttribute("bgcolor");
				// System.out.println(attributeColor);
				return attributeColor.equals("cccfe6");
			}catch(Exception ex){
				return false;
			}
		}else{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://bant.com.ua/pricelist.htm";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://bant.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table/tbody/tr[2]/td/table/tbody/tr/td[2]/table/tbody/tr/td[2]/table/tbody/tr[3]/td/table/tbody";
	}
