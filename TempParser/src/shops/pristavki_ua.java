...
public class pristavki_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.pristavki.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.pristavki.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/table[2]/tbody/tr/td/table/tbody/tr/td[2]/table[3]/tbody/tr/td/table/tbody";
	}
