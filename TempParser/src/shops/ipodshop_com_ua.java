...
public class ipodshop_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://ipodshop.com.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://ipodshop.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr[5]/td/table/tbody/tr/td[2]/span/table/tbody/tr[2]/td/table[2]/tbody/tr/td[2]/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody";
	}
