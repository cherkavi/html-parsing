...
public class exoticmobile_com_ua extends TableSinglePage{

	@Override
	protected Record getRecordFromRow(Node node) {
		if(((Element)this.parser.getNodeFromNode(node, "/td[5]")).getTextContent().indexOf("есть")>=0){
			...
			try{
				...
				Element priceElement=(Element)this.parser.getNodeFromNode(node, "/td[2]/span");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.exoticmobile.com.ua/pricelist.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.exoticmobile.com.ua";
	}
