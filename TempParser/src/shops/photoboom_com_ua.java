...
public class photoboom_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.photoboom.com.ua/pricelist/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.photoboom.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/HTML/BODY/DIV[@class=\"all_wrapper\"]/TABLE[2]/TBODY/TR/TD[@id=\"container_main_content\"]/DIV[@class=\"cpt_maincontent\"]/CENTER/P[2]/table/tbody";
	}
