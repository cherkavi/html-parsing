...
public class ipod_apple_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.ipod-apple.com.ua/show_price/yes/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.ipod-apple.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/center/table/tbody/tr[3]/td/table/tbody/tr/td[2]/table/tbody/tr/td/center/table/tbody";
	}
