...
public class mediamart_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.mediamart.com.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.mediamart.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table[2]/tbody/tr/td[4]/table/tbody/tr[2]/td/table/tbody/tr/td[2]/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody";
	}
