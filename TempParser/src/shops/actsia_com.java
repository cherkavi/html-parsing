...
public class actsia_com extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://actsia.com/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://actsia.com";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/div/div[2]/div/div/div[2]/table/tbody/tr[2]/td/table/tbody";
	}
