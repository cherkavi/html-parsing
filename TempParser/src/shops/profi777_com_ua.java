...
public class profi777_com_ua extends AnalisatorRecordListBaseMultiPage {
	@Override
	public String getShopUrlStartPage() {
		return "http://www.profi777.com.ua";
	}
	...
	protected ISectionFinder getSectionFinder() throws Exception {
		...
		return new RecursiveFinder(
				this.parser
						.getNodeListFromUrl(
								"http://www.profi777.com.ua",
								"windows-1251",
								"/HTML/BODY/TABLE[2]/TBODY/TR/TD[1]/TABLE/TBODY/TR[1]/TD/TABLE/TBODY/TR/TD/TABLE/TBODY/TR[2]/TD[@class=\"mws_boxCenter\"]/TABLE/TBODY/TR[2]/TD[@class=\"boxText\"]/A[*]"),
	...
	protected String[] getThreePageForAnalisator() {
		return new String[] {
				"http://profi777.com.ua/videonabljudenie/c-33.html",
				"http://profi777.com.ua/videonabljudenie/c-33.html?page=2&sort=products_sort_order",
				"http://profi777.com.ua/videonabljudenie/c-33.html?page=3&sort=products_sort_order", };
	}
