...
public class gamepost_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://gamepost.com.ua/?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://gamepost.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/center[2]/table/tbody/tr/td[2]/center/p[2]/table/tbody";
	}
