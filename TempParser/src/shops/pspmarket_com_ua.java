...
public class pspmarket_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://pspmarket.com.ua/Wce3e0f85117a2.htm";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://pspmarket.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/center/table/tbody/tr/td/table/tbody/tr[3]/td[2]/table/tbody/tr[2]/td[2]/center/table/tbody";
	}
