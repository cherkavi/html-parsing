...
public class teploprofi_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://teploprofi.com.ua/pricelist/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://teploprofi.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div[3]/table/tbody/tr/td[2]/div/center/p[2]/table/tbody";
	}
