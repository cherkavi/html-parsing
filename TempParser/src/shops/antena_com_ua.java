...
public class antena_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				name=(Element)this.parser.getNodeFromNode(node, "/td[1]")+" "+nodeName.getTextContent().trim();
	...
	protected String getFullHttpUrlToPrice() {
		return "http://antena.com.ua/?path=0/2/1085";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://antena.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr[4]/td/table/tbody/tr[2]/td/table[2]/tbody";
	}
