...
public class techno_store_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://tehno-store.com.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://tehno-store.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/table[4]/tbody/tr/td/table/tbody/tr/td[2]/table[3]/tbody/tr/td/table/tbody";
	}
