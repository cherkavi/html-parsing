...
public class marketus_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				price=getFloatFromString(priceElementText);
	...
	protected String getFullHttpUrlToPrice() {
		return "http://marketus.com.ua/pricelist/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://marketus.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div[@class=\"all_wrapper\"]/table[@class=\"apl_main\"]/tbody/tr[2]/td[@id=\"container_main_content\"]/div[@class=\"whitebg\"]/table[@class=\"in_maincontent\"]/tbody/tr/td/div[@class=\"cpt_maincontent\"]/center/table[2]/tbody";
	}
