...
public class diant_kiev_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://diant.kiev.ua/index.php?ukey=pricelist";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://diant.kiev.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/div/div/div/div/table[2]/tbody/tr/td[2]/div/center/p[2]/table/tbody";
	}
