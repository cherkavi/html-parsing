...
public class kruche_net_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				name=this.removeStartPage(nodeName.getTextContent().trim());
	...
	protected String getFullHttpUrlToPrice() {
		return "http://kruche.net.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://kruche.net.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[4]/tbody/tr/td[2]/table/tbody/tr/td/table[2]/tbody/tr/td[2]/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td/table/tbody";
	}
