...
public class cdma_mobile_com extends MultiFileParseManager<CsvReader, String[]>{
	...
	protected String[] getShopPriceFileUrl() {
		return new String[]{"http://www.cdma-mobile.com/price/full_price/"};
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.cdma-mobile.com";
	}
