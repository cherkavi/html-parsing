...
public class trixi_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://trixi.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://trixi.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[3]/tbody/tr/td[2]/table/tbody/tr/td/center/p[2]/table/tbody";
	}
