...
public class rodnik_in_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.rodnik.in.ua/index.php?show_price";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.rodnik.in.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div[4]/table[2]/tbody/tr/td/table/tbody";
	}
