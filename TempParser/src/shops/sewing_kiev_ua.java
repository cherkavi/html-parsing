...
public class sewing_kiev_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.sewing.kiev.ua/pricelist/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.sewing.kiev.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/div[2]/div/div/div/table[2]/tbody";
	}
