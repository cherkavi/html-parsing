...
public class texnosvit_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				int indexOfAnd=url.indexOf("&");
				if(indexOfAnd>0){
					url=url.substring(0,indexOfAnd);
				}
	...
	protected String getFullHttpUrlToPrice() {
		return "http://texnosvit.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://texnosvit.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[3]/tbody/tr/td[2]/table/tbody/tr/td/span/center/p[2]/table/tbody";
	}
