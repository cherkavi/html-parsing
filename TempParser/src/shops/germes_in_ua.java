...
public class germes_in_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				url=this.removeStartPage(this.removeAfterSymbolIncludeIt(url, '?'));
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.germes.in.ua/price.php";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.germes.in.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[4]/tbody/tr/td[2]/table/tbody/tr[2]/td/table[2]/tbody/tr/td[2]/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td/table/tbody";
	}
