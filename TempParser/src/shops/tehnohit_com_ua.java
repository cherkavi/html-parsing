...
public class tehnohit_com_ua extends TableSinglePage{

	@Override
	protected Record getRecordFromRow(Node node) {
		if(((Element)this.parser.getNodeFromNode(node, "/td[2]")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				priceUSD=getFloatFromString(priceElementText);
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.tehnohit.com.ua/pricelist/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.tehnohit.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/HTML/BODY/DIV[@class=\"all_wrapper\"]/TABLE[3]/TBODY/TR/TD[@id=\"container_main_content\"]/DIV[@class=\"cpt_maincontent\"]/CENTER/TABLE[2]/TBODY";
	}
