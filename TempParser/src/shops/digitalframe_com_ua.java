...
public class digitalframe_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				Element priceElement=(Element)this.parser.getNodeFromNode(node, "/td[2]/nobr/font");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.digitalframe.com.ua/price.htm";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.digitalframe.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[3]/tbody/tr/td[3]/table/tbody/tr/td/center/p[2]/table/tbody";
	}
