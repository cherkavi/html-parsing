...
public class xclusive_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://xclusive.com.ua/pricelist/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://xclusive.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[2]/tbody/tr[2]/td/table/tbody/tr/td[2]/div/center/p[2]/table/tbody";
	}
