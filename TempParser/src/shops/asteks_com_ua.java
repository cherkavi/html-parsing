...
public class asteks_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.asteks.com.ua/price.html";
	}
	...
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/div/div/div[6]/table/tbody/tr/td/table[3]/tbody/tr/td/table/tbody";
	}
