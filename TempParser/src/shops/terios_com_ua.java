...
public class terios_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://terios.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://terios.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[4]/tbody/tr/td[2]/table/tbody/tr[2]/td/span/center/p[2]/table/tbody";
	}
