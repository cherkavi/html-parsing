...
public class ntools_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://ntools.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://ntools.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div[4]/div/div/div/div[2]/table/tbody";
	}
