...
public class cen_net_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.cen.net.ua/index.php?ukey=pricelist";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://www.cen.net.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table[3]/tbody/tr/td[2]/div/div/center/div/table/tbody";
	}
