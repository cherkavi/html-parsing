...
public class magazin_com_ua extends AnalisatorRecordListBaseMultiPage {
	@Override
	public String getShopUrlStartPage() {
		return "http://www.magazin.com.ua";
	}
	...
	protected String[] getThreePageForAnalisator() {
		return new String[] { "http://www.magazin.com.ua/subcategory/376",
				"http://www.magazin.com.ua/subcategory/376/0/0/10",
				"http://www.magazin.com.ua/subcategory/376/0/0/20", };
	}
	...
	protected String getXmlPathToRecordListFromDataBlock() {
		return "/tr[5]/TR[*]/TD[@class=\"sub_brend\"]/TABLE/TBODY";
	}
	...
	protected String recordFromNodeInRecordToPrice() {
		return "/TR[2]/TD/TABLE/TBODY/TR/TD[1]/SPAN[@class=\"price_grn\"]";
	}
	...
	protected String recordFromNodeInRecordToPriceUsd() {
		return "/TR[2]/TD/TABLE/TBODY/TR/TD[1]/SPAN[@class=\"price_ye\"]";
	}
