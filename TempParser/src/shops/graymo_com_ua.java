...
public class graymo_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://graymo.com.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://graymo.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/center/table[2]/tbody/tr/td/table/tbody/tr[3]/td[2]/table/tbody/tr[2]/td[2]/center/p[2]/table/tbody";
	}
