...
public class first_line_kiev_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://first-line.kiev.ua/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://first-line.kiev.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr/td[2]/span/center/p[2]/table/tbody";
	}
