...
public class tehnosvit_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://tehnosvit.com.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://tehnosvit.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/div/table/tbody/tr/td[2]/div/div/div/table[2]/tbody/tr/td/table/tbody";
	}
