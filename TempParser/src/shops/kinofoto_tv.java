...
public class kinofoto_tv extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://kinofoto.tv/index.php?show_price=yes";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://kinofoto.tv";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/center/table/tbody/tr[3]/td[2]/table/tbody/tr/td/center/p[2]/table/tbody";
	}
