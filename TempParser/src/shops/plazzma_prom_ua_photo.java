...
public class plazzma_prom_ua_photo extends TableSinglePage{
	...
	protected String getSectionNameFromRow(Node node) {
		return this.parser.getTextContentFromNode(node, "/td/h2", "");
	}
	...
	protected String getFullHttpUrlToPrice() {
		...
		return analisator.getUrlFromPageFromElement("http://plazzma.prom.ua/price_lists.html", this.getCharset(), "/html/body/div/div[6]/div/div[2]/div/a");
	}
	...
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/div[5]/div/table/tbody";
	}
