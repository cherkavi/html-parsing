...
public class ukrclimate_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		if(((Element)this.parser.getNodeFromNode(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				Element nodeName=(Element)this.parser.getNodeFromNode(node, "/td[1]/b/a");
	...
	protected String getFullHttpUrlToPrice() {
		return "http://ukrclimate.com.ua/pricelist/";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://ukrclimate.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table/tbody/tr/td/table[5]/tbody/tr/td[2]/table/tbody/tr[2]/td[2]/div/center/p[2]/table/tbody";
	}
