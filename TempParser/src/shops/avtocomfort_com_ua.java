...
public class avtocomfort_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				String priceElementText=priceElement.getTextContent().toUpperCase().replaceAll("[.А-ЯA-Z $,]", "");
				...
				price=Float.parseFloat(removeLastSymbol(priceElementText,1));
	...
	protected String getFullHttpUrlToPrice() {
		return "http://avtocomfort.com.ua/price.html";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://avtocomfort.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/table[3]/tbody/tr/td[2]/table/tbody/tr[2]/td/span/center/p[2]/table/tbody";
	}
