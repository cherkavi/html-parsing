...
public class santehnika_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://santehnika.ua/shop/index.php?ukey=pricelist";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://santehnika.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/div/div[3]/table/tbody/tr/td[2]/div/center/p[2]/table/tbody";
	}
