...
public class newmart_com_ua extends TableSinglePage{
	...
	protected String getFullHttpUrlToPrice() {
		return "http://www.newmart.com.ua/index.php?show_price=yes";
	}
	...
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table/tbody/tr/td[2]/center/table[2]/tbody";
	}
