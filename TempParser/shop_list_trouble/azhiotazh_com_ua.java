...
public class azhiotazh_com_ua extends TableSinglePage{
	...
	protected Record getRecordFromRow(Node node) {
		// if(((Element)this.parser.getNodeFromNodeAlternative(node, "/td[2]/nobr")).getTextContent().indexOf("На складе")>=0){
			...
			try{
				...
				String errorString="(Подробнее...".toUpperCase();
				if(name.toUpperCase().endsWith(errorString)){
					name=name.substring(0, name.length()-errorString.length());
				}
	...
	protected String getFullHttpUrlToPrice() {
		return "http://azhiotazh.com.ua/index.php?ukey=pricelist";
	}

	@Override
	public String getShopUrlStartPage() {
		return "http://azhiotazh.com.ua";
	}

	@Override
	protected String getXmlPathToMainBlock() {
		return "/html/body/div/table/tbody/tr[2]/td[2]/div[3]/center/p[2]/table/tbody";
	}
