...
public class DatabaseConnection implements IConnector{
	 ...
	 * @param poolSize - размер pool-а
	 * @throws Exception - если не удалось создать соединение с базой данных 
	 */
	public DatabaseConnection(String driverName, String url, String userName, String password, int poolSize) throws Exception {
		this.connectorPool=new ConnectorPool(driverName, url, userName, password, poolSize);
	}
