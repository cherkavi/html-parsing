...
public class Connector {
	...
	private Class<?>[] classOfDatabase=null;
	{
		...
		classOfDatabase=new Class[]{
				   // INFO Hibernate determinate the classes
						database.wrap_mysql.Action_state.class,
						database.wrap_mysql.Actions.class,
						database.wrap_mysql.Current_action.class,
						database.wrap_mysql.Logger.class,
						database.wrap_mysql.Logger_level.class,
						database.wrap_mysql.Parse_record.class,
						database.wrap_mysql.Parse_result.class,
						database.wrap_mysql.Parse_session.class,
						database.wrap_mysql.Logger.class,
						database.wrap_mysql.Logger_level.class,
						database.wrap_mysql.Section.class,
						database.wrap_mysql.Shop_list.class,
						database.wrap_mysql.Users.class,
				   };
	}
	...
	*/
	 ...
	 * */
	public Connector(DatabaseDrivers driver, 
					 String path, 
					 String userName, 
					 String password,
					 int poolSize) throws Exception {
		System.out.println("Database Connector created:");
		this.connector=new DatabaseConnection(driver.getDriverName(), path, userName, password, poolSize);
	...
	/**
	 * тестирование Pool-а соединений
	 */
